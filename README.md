...
docker image tag ligoj/ligoj-api:3.3.1 $ECR_REGISTRY/ligoj/ligoj-api:3.3.1
docker image tag ligoj/ligoj-ui:3.3.1 $ECR_REGISTRY/ligoj/ligoj-ui:3.3.1
aws ecr get-login-password --region $AWS_REGION | docker login --username AWS --password-stdin $ECR_REGISTRY
docker push $ECR_REGISTRY/ligoj/ligoj-api:3.3.1
docker push $ECR_REGISTRY/ligoj/ligoj-ui:3.3.1
```
