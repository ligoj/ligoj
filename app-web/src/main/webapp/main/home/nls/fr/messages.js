define({
	...
	'mode': 'Mode',
	'service:help': 'Aide',
	'status-service': 'Etat global du service',
	'status-tool': 'Etat global de l\'outil',
	'status-node': 'Etat global du nœud',
	'status-subscription': 'Etat de la souscription',
	'status-subscription-up': 'Souscriptions valides : {{{[0]}}} ({{{[1]}}}%)',
	'status-subscription-down': 'Souscriptions invalides : {{{[0]}}} ({{{[1]}}}%)',
