      ...
      <section class="card">
        <header class="card-head">
          ...
          <svg viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg" class="logo" aria-label="Ligoj">
            ...
            <use fill="#034b80" href="#ll2" />
            <use fill="#ff6900" href="#ll3" />
            <use fill="#4589ca" href="#ll4" />
            <use fill="#ff6900" href="#ll1" />
          </svg>
...
@keyframes blob3 {
  ...
  50% {
    transform: translate(46px, -40px) scale(1.1);
  }
}
...
.alert-info {
  ...
  color: var(--info);
  border-color: rgba(var(--v-theme-info), .35);
}
...
input:focus {
  ...
  box-shadow: 0 0 0 4px rgba(var(--v-theme-secondary), .18);
  background: var(--surface);
}
...
.submit {
  ...
  justify-content: center;
  gap: 8px;
  box-shadow: 0 14px 28px -12px rgba(255, 90, 82, .6);
