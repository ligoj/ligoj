define({
	root: {
		...
		'status-node': 'Global status of the node',
		'status-subscription': 'Status of the subscription',
		'status-subscription-up': 'Valid subscriptions : {{{[0]}}} ({{{[1]}}}%)',
		'status-subscription-down': 'Invalid subscriptions : {{{[0]}}} ({{{[1]}}}%)',
