define({
	'root': {
		'mode-none': 'None',
		'mode-none-tooltip': 'No subscription will be available. Configuration node only',
		'mode-create': 'Create',
		'mode-create-tooltip': 'Subscription in create mode only will be available',
		'mode-link': 'Link',
		'mode-link-tooltip': 'Subscription in link mode only will be available',
		'mode-all': 'All',
