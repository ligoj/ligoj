...
#
# Note: the Node/Vite builder stage uses its own TLS configuration. If your
# npm registry mirror also presents a self-signed cert, configure NPM
# separately (e.g. `npm config set cafile /usr/local/share/ca-certificates/...`
